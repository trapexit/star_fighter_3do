...
#define PAUSE_MENU				2
#define	PLAYERTYPE_MENU 		3
#define GAMEVIEW_MENU 			4
#define	GAMETYPE_MENU			5
#define	PLAYERPOS_MENU			6
#define	GAMEPOS_MENU			7
#define	MISSION_MENU			8
#define	LEVEL_MENU				9
#define	SOUND_MENU				10
#define	JUKEBOX_MENU			11
#define	LOAD_MENU				12
#define	SAVE_MENU				13
#define	CONFIGURE_MENU			14
#define	CONTROLS_MENU			15
#define	DEBRIEF_MENU			16
#define	LANGUAGE_MENU			17
#define	HIGHSCORE_MENU			18
#define	FLIGHTCONTROL_MENU		19
#define	CALIBRATE_JOYSTICK_MENU	20
...
void	menu_setgameview (long);					// Set Camera View for GAME
void	menu_setplayercamera (long);				// Set Camera Type for PLAYER
void	menu_setgamecamera (long);					// Set Camera Type for GAME
