...
#define	MAX_AWARDS 17
#define	MAX_NICEAWARDS 14
...
{0,			C_GREEN,	C_YELLOW,	C_GREEN,	bonus_wingpod,	1,						0,					0},		// Add WINGPOD
...
{C_MAGENTA,	C_RED,		C_MAGENTA,	C_RED,		bonus_weapon,	WEAPON_MEGA_BOMB, 		MTXT__MEGABOMB,		5},		// Increase MEGABOMB
{C_MAGENTA,	C_GREEN,	C_MAGENTA,	C_GREEN,	bonus_weapon,	WEAPON_BEAM_LASER,		MTXT__BEAM_LASER,	50},	// Increase BEAM LASER
...
long	pickup_loop,
	...
	for (award_check=0; award_check < MAX_AWARDS; award_check++)
		...
		if (pickup_status != 2)		// IS THIS OUR AWARD ?
			...
			crystal_awards [award_check].function (	crystal_awards [award_check].parameter1, crystal_awards [award_check].parameter2,
													crystal_awards [award_check].parameter3);
...
void	bonus_weapon (long type, long mttx_weapontextnumber, long value)
...
void	bonus_wingpod (long	value, long nothing1, long nothing2)
...
void	bonus_performance (long	value, long mtxt_bonustype, long nothing2)
...
void	bonus_fastcrystal (long	value, long nothing1, long nothing2)
...
void	bonus_megasetup_start (long value, long nothing1, long nothing2)
